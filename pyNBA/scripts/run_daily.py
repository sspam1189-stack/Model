...
def build_game_injury_adj(away_team, home_team, injury_report, player_mpg=None, recent_injury_dates=None, ofs_players=None):
    away_injuries = get_key_injuries(injury_report, away_team, player_mpg, recent_injury_dates, ofs_players)
    home_injuries = get_key_injuries(injury_report, home_team, player_mpg, recent_injury_dates, ofs_players)
...
def main(subject_label="[PY]"):
    ...
    try:
        ...
        _inj_to_write = {"injuryData": {**injury_data, "report": _merged_report}, "playerAdvanced": player_advanced}
    ...
    for g in odds:
        ...
        try:
            injury_adj = build_game_injury_adj(g["away"], g["home"], injury_data.get("report", {}), injury_data.get("playerMPG"), recent_injury_dates, ofs_players)
        except Exception:
            injury_adj = None
