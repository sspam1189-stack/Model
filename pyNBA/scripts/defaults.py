...
LR_CONFIRM_THRESH = 0.55        # LR P(cover) >= this to confirm Bayesian pick (backtest optimal)
LR_VETO_THRESH    = 0.45        # LR P(cover) < this to veto Bayesian pick (backtest optimal)
