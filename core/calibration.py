# core/calibration.py
# Unified P(cover) calibration module.
    ...
    for bucket in BUCKETS:
        ...
        rows.append({
            ...
            "spread": {
                ...
                "units": round((hits["spread"]["w"] * (1 / JUICE) - hits["spread"]["l"]) * 10) / 10 if s_n > 0 else 0,
            },
            "total": {
                "n": t_n,
                "winPct": round(100 * hits["total"]["w"] / t_n) if t_n > 0 else None,
                "units": round((hits["total"]["w"] * (1 / JUICE) - hits["total"]["l"]) * 10) / 10 if t_n > 0 else 0,
            },
        })
