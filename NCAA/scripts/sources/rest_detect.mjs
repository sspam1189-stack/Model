...
export async function detectB2B() {
  ...
  const url = `https://site.api.espn.com/apis/site/v2/sports/basketball/mens-college-basketball/scoreboard?dates=${date}&groups=50&limit=365`;
...
function findStatKey(stats, teamName) {
  ...
  for (const k of Object.keys(stats)) {
    const nk = normKey(k);
    if (nk === wanted || safeFuzzy(nk, wanted)) return k;
  }
