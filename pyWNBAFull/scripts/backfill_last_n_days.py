...
CACHE_DIR = os.path.join(SCRIPTS_DIR, "..", "data", "stats_cache", "wnba")

# Days at the START of the window (oldest) used for warm-up only — picks not evaluated
BURN_IN_DAYS = 0  # MIN_GP handles warm-up — count every pick that fires

# Minimum games a team must have played before we trust its stats (WNBA short season)
MIN_GAMES = 5
