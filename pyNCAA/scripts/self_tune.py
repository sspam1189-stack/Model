...
_tune.HCA_CLAMP_LO = getattr(defaults, 'HCA_CLAMP_LO', 2.0)
_tune.HCA_CLAMP_HI = getattr(defaults, 'HCA_CLAMP_HI', 6.0)
_tune.HCA_VAR_FLOOR = getattr(defaults, 'HCA_VAR_FLOOR', 0.3)
