...
export const KALMAN_DEFAULTS = {
  // Initial uncertainty per team (points²). ±4 points = variance 16.
  // This is wide enough that early games move the estimate meaningfully,
  // but not so wide that one blowout dominates.
  initialVar: 16,

  // Game outcome noise (points²). NBA games have ~12 point std dev in margin
  // after accounting for team strength. 12² = 144.
  // This is the "how much randomness is in a single game" parameter.
  gameNoise: 144,
