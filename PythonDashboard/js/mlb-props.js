// MLB Pitcher Props rendering
    ...
    function buildMLBMarketBreakdown(filteredPicks) {
      const mlbMarketLabels = {strikeouts:'K', outs:'OUTS', hits_allowed:'HA', walks:'BB', game_hits:'HITS'};
      const mlbMarketOrder = ['K','OUTS','HA','BB','HITS'];
      const fGrouped = {};
    ...
    async function renderMLBProps() {
      ...
      const marketLabels = {strikeouts:'K', outs:'OUTS', hits_allowed:'HA', walks:'BB', game_hits:'HITS'};
      ...
      (function renderMLBDailyCards() {
        ...
        if (yesterdayPicks.length > 0) {
          ...
          const yCatOrder = {strikeouts:0, outs:1, hits_allowed:2, walks:3, game_hits:4};
        ...
        if (todayPicks.length > 0) {
          ...
          const tbody = tbl.createTBody();
          const catOrder = {strikeouts:0, outs:1, hits_allowed:2, walks:3, game_hits:4};
      ...
      (function renderGamesSection() {
        ...
        const mktFilters = ['all','strikeouts','outs','hits_allowed','walks'];
        let activeMkt = 'all';
        ...
        const catOrd = {strikeouts:0, outs:1, hits_allowed:2, walks:3, game_hits:4};
      ...
      const mlbButtonOrder = ['strikeouts','outs','hits_allowed','walks','game_hits'];
