...
// LINE CONVENTION (sportsbook): line < 0 = home FAV, line > 0 = away FAV
// So: home is DOG when line > 0, away is DOG when line < 0

function gradeSpread(g, side) {
  // Sportsbook convention: line < 0 = home fav, line > 0 = home dog
  // Home covers ATS when: homeMargin + line > 0
  //   Home fav -7: homeMargin + (-7) > 0 => must win by > 7
  //   Home dog +7: homeMargin + 7 > 0 => can lose by < 7
