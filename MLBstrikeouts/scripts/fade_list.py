...
FADE_LIST = [
    ...
    # McLean removed 2026-08-17, Tolle removed 2026-08-19 (user); history
    # stays (see FADE_WINDOW).
...
FADE_WINDOW = {
    ...
    # Removed 2026-08-19 (user): no fades from 8/19 on (drops today's home
    # BOS->ARI +138), prior record stays (5-3 +2.78u overall; home 4-2
    # +2.52u). Retired on current form, not price: 2.61 ERA / 34.2% K over
    # his last 5 — the fade had no matchup support left. FADE_VENUE keeps
    # his "home" entry so the prior record still grades home-only.
    "Tolle":             {"add": SEASON_START, "remove": "2026-08-19"},
