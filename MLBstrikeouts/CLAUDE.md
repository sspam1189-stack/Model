...
6. **Non-scout systems — EIGHT CARDED (five 2026-09-01, three 2026-09-02; user).** A separate
   ...
   | Starter over run | a starter 75%+ overs in his last 8, total >= 8.0, both starters 6+ GS, other starter <=0.40 or >=0.75 (was total >= 8.5 with no partner/start condition before 2026-09-03) | 120-87 | +10.8% | -6.1% |
